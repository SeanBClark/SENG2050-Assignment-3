        ...
        <div class = 'align-self-center page-div'>
            ...
            <div class = 'body'>
                ...
                <ul class = "list-group">
                    ...
                    <c:forEach var = "item" items = "${sessionScope.courseList}">
                        ...
                        <li class = "list-group-item justify-content-md-center border-0">
                            ...
                            <div class = 'row justify-content-md-center'>
                                ...
                                <div class = 'col col-lg-2'>
                                    ...
                                    <a href="/Assignment3/GroupManagement?courseID=${item.getCourseId()}">

                                        <button class="btn btn-success my-2 my-sm-0" type="button">Select Course</button>
