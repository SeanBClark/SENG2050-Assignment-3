<%-- Page for groups to invite more members --%>
...
<!DOCTYPE html>
    ...
    <head>
        ...
        <link rel = "stylesheet" href ="../Assignment3/views/group_invite/group_invite.css" type = "text/css">
        ...
        <script type =  'text/javascript' src = '../Assignment3/views/group_invite/group_invite.js'></script>
